...
def pose_callback(msg):
    ...
    if not t_matrix:
        ...
        r13, r31, x_translation, z_translation = t_matrix[2], t_matrix[8], t_matrix[3], t_matrix[11] 
        if z_translation > 0.05:
            ...
            if x_translation < -0.05:
                ...
                if z_translation >= 0.2:
                    move_forward(z_translation/5, args.left_forward_speed, args.right_forward_speed)
                else:
                    move_forward(z_translation/2, args.left_forward_speed, args.right_forward_speed)
